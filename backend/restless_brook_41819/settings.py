"""
Django settings for restless_brook_41819 project.
...
ROOT_URLCONF = 'restless_brook_41819.urls'
...
WSGI_APPLICATION = 'restless_brook_41819.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "restless_brook_41819 API",
    "DESCRIPTION": "API documentation for restless_brook_41819 App",
    "VERSION": "v1",
}
